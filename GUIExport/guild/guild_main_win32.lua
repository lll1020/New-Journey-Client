...
function ui.init(parent)
	...
	GUI:setContentSize(Image_frame1, 332, 82)
	...
	-- Create Image_master
	local Image_master = GUI:Image_Create(PMainUI, "Image_master", 460.00, 360.00, "res/private/guild_ui_win32/word_hhzy_04.png")
	GUI:setContentSize(Image_master, 46, 22)
	GUI:setIgnoreContentAdaptWithSize(Image_master, false)
	...
	GUI:setContentSize(Image_frame2, 332, 198)
	...
	GUI:setContentSize(Image_notice, 86, 24)
	GUI:setIgnoreContentAdaptWithSize(Image_notice, false)
	...
	-- Create EditInput
	local EditInput = GUI:TextInput_Create(PMainUI, "EditInput", 460.00, 257.00, 260.00, 142.00, 14)
