...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 201.00, 485.00, 18, "#d8c8ae", [[行会]])
	...
	-- Create AttachLayout
	local AttachLayout = GUI:Layout_Create(FrameLayout, "AttachLayout", 78.00, 18.00, 732.00, 445.00, false)
	GUI:setChineseName(AttachLayout, "行会_内容布局")
	GUI:setTouchEnabled(AttachLayout, false)
	GUI:setTag(AttachLayout, -1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 826.00, 476.00, "res/public/1900000510.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 15.00, 48.00, 16, "#807256", [[行
会]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 15.00, 48.00, 16, "#807256", [[成
员]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_2, "TouchSize", 0.00, 82.00, 33.00, 75.00, false)
	...
	-- Create page_cell_3
	local page_cell_3 = GUI:Button_Create(FrameLayout, "page_cell_3", 826.00, 213.00, "res/wy/public/guild_1.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 15.00, 48.00, 16, "#807256", [[列
表]])
