...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_login, "Image_1", 200.00, 175.00, "res/wy/public/login_0.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_account, "Text_1", 50.00, 108.00, 18, "#ffffff", [[账　号]])
	...
	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_account, "Text_1_0", 50.00, 58.00, 18, "#ffffff", [[密　码]])
	...
	-- Create Image_5
	local Image_5 = GUI:Image_Create(Panel_account, "Image_5", 179.00, 107.00, "res/private/login/account/bg_shuru_03.png")
	GUI:setContentSize(Image_5, 185, 30)
	...
	-- Create Image_5_0
	local Image_5_0 = GUI:Image_Create(Panel_account, "Image_5_0", 179.00, 57.00, "res/private/login/account/bg_shuru_03.png")
	GUI:setContentSize(Image_5_0, 185, 30)
	...
	local TextField_username = GUI:TextInput_Create(Panel_account, "TextField_username", 90.00, 107.00, 180.00, 30.00, 22)
	...
	local TextField_password = GUI:TextInput_Create(Panel_account, "TextField_password", 90.00, 58.00, 180.00, 30.00, 22)
	...
	-- Create Panel_phone
	local Panel_phone = GUI:Layout_Create(Panel_login, "Panel_phone", 39.00, 232.00, 300.00, 90.00, false)
	GUI:setChineseName(Panel_phone, "登录框_手机登录组合")
	GUI:setTouchEnabled(Panel_phone, true)
	GUI:setTag(Panel_phone, 341)

	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_phone, "Text_2", 55.00, 65.00, 18, "#ffffff", [[手机号]])
	...
	-- Create Text_2_0
	local Text_2_0 = GUI:Text_Create(Panel_phone, "Text_2_0", 55.00, 16.00, 18, "#ffffff", [[验证码]])
	...
	-- Create Image_6
	local Image_6 = GUI:Image_Create(Panel_phone, "Image_6", 186.00, 65.00, "res/private/login/account/bg_shuru_03.png")
	GUI:setContentSize(Image_6, 185, 30)
	...
	-- Create Image_6_0
	local Image_6_0 = GUI:Image_Create(Panel_phone, "Image_6_0", 149.00, 15.00, "res/private/login/account/bg_shuru_03.png")
	GUI:setContentSize(Image_6_0, 110, 30)
	...
	local TextField_phoneId = GUI:TextInput_Create(Panel_phone, "TextField_phoneId", 96.00, 65.00, 180.00, 30.00, 22)
	...
	local TextField_authcode = GUI:TextInput_Create(Panel_phone, "TextField_authcode", 97.00, 16.00, 100.00, 30.00, 22)
	...
	local Button_authcode = GUI:Button_Create(Panel_phone, "Button_authcode", 240.00, 16.00, "res/wy/public/login_18.png")
	GUI:Button_loadTexturePressed(Button_authcode, "res/wy/public/login_181.png")
	GUI:setContentSize(Button_authcode, 76, 40)
	...
	local Text_remaining = GUI:Text_Create(Panel_phone, "Text_remaining", 285.00, 17.00, 20, "#ffffff", [[19]])
	...
	local Button_register = GUI:Button_Create(Panel_login, "Button_register", 128.00, 190.00, "res/wy/public/login_14.png")
	GUI:Button_loadTexturePressed(Button_register, "res/wy/public/login_141.png")
	GUI:setContentSize(Button_register, 116, 44)
	...
	local Button_submit = GUI:Button_Create(Panel_login, "Button_submit", 267.00, 190.00, "res/wy/public/login_15.png")
	GUI:Button_loadTexturePressed(Button_submit, "res/wy/public/login_151.png")
	GUI:setContentSize(Button_submit, 116, 44)
	...
	local Button_change_question = GUI:Button_Create(Panel_login, "Button_change_question", 128.00, 130.00, "res/wy/public/login_10.png")
	GUI:Button_loadTexturePressed(Button_change_question, "res/wy/public/login_101.png")
	GUI:setContentSize(Button_change_question, 116, 44)
	...
	local Button_change_password = GUI:Button_Create(Panel_login, "Button_change_password", 267.00, 130.00, "res/wy/public/login_19.png")
	GUI:Button_loadTexturePressed(Button_change_password, "res/wy/public/login_191.png")
	GUI:setContentSize(Button_change_password, 116, 44)
	...
	local Button_bind_phone = GUI:Button_Create(Panel_login, "Button_bind_phone", 128.00, 70.00, "res/wy/public/login_16.png")
	GUI:Button_loadTexturePressed(Button_bind_phone, "res/wy/public/login_161.png")
	GUI:setContentSize(Button_bind_phone, 116, 44)
	...
	local Button_change_phone = GUI:Button_Create(Panel_login, "Button_change_phone", 267.00, 70.00, "res/wy/public/login_17.png")
	GUI:Button_loadTexturePressed(Button_change_phone, "res/wy/public/login_171.png")
	GUI:setContentSize(Button_change_phone, 116, 44)
	...
	local Button_identify = GUI:Button_Create(Panel_login, "Button_identify", 128.00, 10.00, "res/wy/public/login_13.png")
	GUI:Button_loadTexturePressed(Button_identify, "res/wy/public/login_131.png")
	GUI:setContentSize(Button_identify, 116, 44)
	...
	-- Create Text_phone
	local Text_phone = GUI:Button_Create(Panel_login, "Text_phone", 267.00, 10.00, "res/wy/public/login_11.png")
	GUI:setContentSize(Text_phone, 116, 44)
	...
	-- Create Text_account
	local Text_account = GUI:Button_Create(Panel_login, "Text_account", 268.00, 25.00, "res/wy/public/login_20.png")
	GUI:setContentSize(Text_account, 116, 44)
