...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_bg, "Image_1", 328.00, 233.00, "res/wy/public/login_4.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_bg, "Button_close", 640.00, 431.00, "res/public/btn_normal_2.png")
	...
	GUI:setVisible(Text_1_1_3_0, false)
	GUI:Text_enableOutline(Text_1_1_3_0, "#000000", 3)

	-- Create Image_5_1
	local Image_5_1 = GUI:Image_Create(Panel_bg, "Image_5_1", 361.00, 349.00, "res/private/login/account/bg_shuru_02.png")
	GUI:setContentSize(Image_5_1, 200, 30)
	...
	-- Create Image_5_1_1
	local Image_5_1_1 = GUI:Image_Create(Panel_bg, "Image_5_1_1", 361.00, 300.00, "res/private/login/account/bg_shuru_02.png")
	GUI:setContentSize(Image_5_1_1, 200, 30)
	...
	-- Create Image_5_1_2
	local Image_5_1_2 = GUI:Image_Create(Panel_bg, "Image_5_1_2", 315.00, 249.00, "res/private/login/account/bg_shuru_01.png")
	GUI:setContentSize(Image_5_1_2, 110, 30)
	...
	-- Create Image_5_1_3
	local Image_5_1_3 = GUI:Image_Create(Panel_bg, "Image_5_1_3", 360.00, 201.00, "res/private/login/account/bg_shuru_02.png")
	GUI:setContentSize(Image_5_1_3, 200, 30)
	...
	-- Create Image_5_1_4
	local Image_5_1_4 = GUI:Image_Create(Panel_bg, "Image_5_1_4", 314.00, 151.00, "res/private/login/account/bg_shuru_01.png")
	GUI:setContentSize(Image_5_1_4, 110, 30)
	...
	local TextField_username = GUI:TextInput_Create(Panel_bg, "TextField_username", 261.00, 349.00, 200.00, 30.00, 22)
	...
	local TextField_phone = GUI:TextInput_Create(Panel_bg, "TextField_phone", 261.00, 302.00, 200.00, 30.00, 22)
	...
	local TextField_authcode = GUI:TextInput_Create(Panel_bg, "TextField_authcode", 260.00, 249.00, 110.00, 30.00, 22)
	...
	local TextField_phone_new = GUI:TextInput_Create(Panel_bg, "TextField_phone_new", 260.00, 201.00, 200.00, 30.00, 22)
	...
	local TextField_authcode_new = GUI:TextInput_Create(Panel_bg, "TextField_authcode_new", 259.00, 150.00, 110.00, 30.00, 22)
	...
	local Button_authcode = GUI:Button_Create(Panel_bg, "Button_authcode", 425.00, 251.00, "res/wy/public/login_18.png")
	GUI:Button_loadTexturePressed(Button_authcode, "res/wy/public/login_181.png")
	GUI:setContentSize(Button_authcode, 86, 44)
	...
	local Button_authcode_new = GUI:Button_Create(Panel_bg, "Button_authcode_new", 445.00, 145.00, "res/wy/public/login_18.png")
	GUI:Button_loadTexturePressed(Button_authcode_new, "res/wy/public/login_181.png")
	GUI:setContentSize(Button_authcode_new, 86, 44)
	...
	local Text_remaining = GUI:Text_Create(Panel_bg, "Text_remaining", 477.00, 249.00, 20, "#ffffff", [[19]])
	...
	local Text_remaining_new = GUI:Text_Create(Panel_bg, "Text_remaining_new", 495.00, 145.00, 20, "#ffffff", [[19]])
