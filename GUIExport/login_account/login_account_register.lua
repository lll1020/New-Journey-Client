...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_bg, "Image_1", 315.00, 245.00, "res/wy/public/login_5.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_bg, "Button_close", 627.00, 442.00, "res/public/btn_normal_2.png")
	...
	-- Create Image_5_1
	local Image_5_1 = GUI:Image_Create(Panel_bg, "Image_5_1", 235.00, 351.00, "res/private/login/account/bg_shuru_03.png")
	...
	-- Create Image_5_1_0
	local Image_5_1_0 = GUI:Image_Create(Panel_bg, "Image_5_1_0", 235.00, 303.00, "res/private/login/account/bg_shuru_03.png")
	...
	-- Create Image_5_1_1
	local Image_5_1_1 = GUI:Image_Create(Panel_bg, "Image_5_1_1", 235.00, 253.00, "res/private/login/account/bg_shuru_03.png")
	...
	-- Create Image_5_1_2
	local Image_5_1_2 = GUI:Image_Create(Panel_bg, "Image_5_1_2", 235.00, 203.00, "res/private/login/account/bg_shuru_03.png")
	...
	-- Create Image_5_1_3
	local Image_5_1_3 = GUI:Image_Create(Panel_bg, "Image_5_1_3", 235.00, 154.00, "res/private/login/account/bg_shuru_03.png")
	...
	local TextField_username = GUI:TextInput_Create(Panel_bg, "TextField_username", 134.00, 352.00, 200.00, 30.00, 22)
	...
	local TextField_password = GUI:TextInput_Create(Panel_bg, "TextField_password", 136.00, 302.00, 200.00, 30.00, 22)
	...
	local TextField_password_confirm = GUI:TextInput_Create(Panel_bg, "TextField_password_confirm", 136.00, 254.00, 200.00, 30.00, 22)
	...
	local TextField_question = GUI:TextInput_Create(Panel_bg, "TextField_question", 135.00, 203.00, 200.00, 30.00, 22)
	...
	local TextField_answer = GUI:TextInput_Create(Panel_bg, "TextField_answer", 136.00, 154.00, 200.00, 30.00, 22)
	...
	local Button_submit = GUI:Button_Create(Panel_bg, "Button_submit", 300.00, 76.00, "res/wy/public/login_12.png")
