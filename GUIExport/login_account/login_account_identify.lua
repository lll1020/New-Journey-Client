...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_bg, "Image_1", 328.00, 233.00, "res/wy/public/login_3.png")
	...
	GUI:setVisible(Text_title, false)
	GUI:Text_enableOutline(Text_title, "#000000", 3)

	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_bg, "Button_close", 641.00, 432.00, "res/public/btn_normal_2.png")
	...
	-- Create Image_5_1_0
	local Image_5_1_0 = GUI:Image_Create(Panel_bg, "Image_5_1_0", 360.00, 302.00, "res/private/login/account/bg_shuru_02.png")
	...
	local TextField_name = GUI:TextInput_Create(Panel_bg, "TextField_name", 261.00, 349.00, 200.00, 30.00, 22)
	...
	local TextField_IDnumber = GUI:TextInput_Create(Panel_bg, "TextField_IDnumber", 261.00, 302.00, 200.00, 30.00, 22)
