...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_bg, "Image_1", 328.00, 233.00, "res/wy/public/login_1.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_bg, "Button_close", 639.00, 431.00, "res/public/btn_normal_2.png")
	...
	-- Create Image_5_1
	local Image_5_1 = GUI:Image_Create(Panel_bg, "Image_5_1", 360.00, 349.00, "res/private/login/account/bg_shuru_02.png")
	...
	-- Create Image_5_1_0
	local Image_5_1_0 = GUI:Image_Create(Panel_bg, "Image_5_1_0", 362.00, 301.00, "res/private/login/account/bg_shuru_02.png")
	...
	-- Create Image_5_1_1
	local Image_5_1_1 = GUI:Image_Create(Panel_bg, "Image_5_1_1", 362.00, 251.00, "res/private/login/account/bg_shuru_02.png")
	...
	-- Create Image_5_1_2
	local Image_5_1_2 = GUI:Image_Create(Panel_bg, "Image_5_1_2", 362.00, 201.00, "res/private/login/account/bg_shuru_02.png")
	GUI:setContentSize(Image_5_1_2, 200, 30)
	...
	local Image_5_1_2_0 = GUI:Image_Create(Panel_bg, "Image_5_1_2_0", 314.00, 150.00, "res/private/login/account/bg_shuru_01.png")
	GUI:setContentSize(Image_5_1_2_0, 110, 30)
	...
	local TextField_username = GUI:TextInput_Create(Panel_bg, "TextField_username", 259.00, 349.00, 200.00, 30.00, 22)
	...
	local TextField_question = GUI:TextInput_Create(Panel_bg, "TextField_question", 261.00, 302.00, 200.00, 30.00, 22)
	...
	local TextField_answer = GUI:TextInput_Create(Panel_bg, "TextField_answer", 261.00, 252.00, 200.00, 30.00, 22)
	...
	local TextField_phone = GUI:TextInput_Create(Panel_bg, "TextField_phone", 261.00, 202.00, 200.00, 30.00, 22)
	...
	local TextField_authcode = GUI:TextInput_Create(Panel_bg, "TextField_authcode", 259.00, 150.00, 110.00, 30.00, 22)
	...
	local Button_authcode = GUI:Button_Create(Panel_bg, "Button_authcode", 425.00, 151.00, "res/wy/public/login_18.png")
	...
	local Text_remaining = GUI:Text_Create(Panel_bg, "Text_remaining", 483.00, 150.00, 20, "#ffffff", [[19]])
