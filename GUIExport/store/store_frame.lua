...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 197.00, 484.00, 20, "#d8c8ae", [[123]])
	...
	-- Create AttachLayout
	local AttachLayout = GUI:Layout_Create(FrameLayout, "AttachLayout", 80.00, 18.00, 732.00, 445.00, false)
	GUI:setChineseName(AttachLayout, "商店框架_详细信息")
	GUI:setTouchEnabled(AttachLayout, false)
	GUI:setTag(AttachLayout, -1)

	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 825.00, 475.00, "res/public/1900000510.png")
	...
	-- Create page_cell_1
	local page_cell_1 = GUI:Button_Create(FrameLayout, "page_cell_1", 826.00, 387.00, "res/wy/public/guild_1.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 15.00, 45.00, 16, "#807256", [[热
销]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_1, "TouchSize", 0.00, 82.00, 33.00, 75.00, false)
	...
	-- Create page_cell_2
	local page_cell_2 = GUI:Button_Create(FrameLayout, "page_cell_2", 826.00, 298.00, "res/wy/public/guild_1.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 15.00, 45.00, 16, "#807256", [[元
宝]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 15.00, 45.00, 16, "#807256", [[灵
符]])
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_4, "PageText", 15.00, 45.00, 16, "#807256", [[技
能]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_4, "TouchSize", 0.00, 81.00, 33.00, 75.00, false)
	...
	-- Create page_cell_5
	local page_cell_5 = GUI:Button_Create(FrameLayout, "page_cell_5", 826.00, 32.00, "res/wy/public/guild_1.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_5, "PageText", 15.00, 45.00, 16, "#807256", [[充
值]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_5, "TouchSize", 0.00, 81.00, 33.00, 75.00, false)
