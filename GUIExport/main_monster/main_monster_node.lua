...
function ui.init(parent)
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_1, "Image_icon", 47.00, -41.00, "res/private/gui_edit/ImageFile.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 367.00, -20.00, "res/private/main_monster_ui/close1.png")
