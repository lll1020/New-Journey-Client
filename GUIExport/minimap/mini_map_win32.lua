...
function ui.init(parent)
	...
	-- Create Panel_map
	local Panel_map = GUI:Layout_Create(Panel_1, "Panel_map", 0.00, 0.00, 657.00, 399.00, false)
	GUI:Layout_setBackGroundImage(Panel_map, "res/wy/public/02.png")
	GUI:setChineseName(Panel_map, "大地图_组合")
	GUI:setTouchEnabled(Panel_map, false)
	GUI:setTag(Panel_map, 56)

	-- Create Panel_minimap
	local Panel_minimap = GUI:Layout_Create(Panel_map, "Panel_minimap", 266.00, 193.00, 500.00, 350.00, false)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_map, "Button_close", 654.00, 361.00, "res/wy/public/20.png")
	GUI:Button_setTitleText(Button_close, "")
	GUI:Button_setTitleColor(Button_close, "#ffffff")
	GUI:Button_setTitleFontSize(Button_close, 0)
	GUI:Button_titleDisableOutLine(Button_close)
	GUI:setTouchEnabled(Button_close, true)
	GUI:setTag(Button_close, -1)

	-- Create Button1
	local Button1 = GUI:Button_Create(Panel_map, "Button1", 521.00, 330.00, "res/wy/public/minian1.png")
	...
	-- Create Button2
	local Button2 = GUI:Button_Create(Panel_map, "Button2", 521.00, 291.00, "res/wy/public/minian2.png")
	...
	-- Create Button3
	local Button3 = GUI:Button_Create(Panel_map, "Button3", 521.00, 252.00, "res/wy/public/minian3.png")
	...
	--
	---- Create Button4
	--local Button4 = GUI:Button_Create(Panel_map, "Button4", 521.00, 213.00, "res/wy/public/minian4.png")
