...
function ui.init(parent)
	...
	-- Create Button1
	local Button1 = GUI:Button_Create(Image_bg, "Button1", 80 + 240 , 13, "res/wy/public/an_zl.png")
	...
	-- Create Button6
	local Button6 = GUI:Button_Create(Image_bg, "Button6", 80 + 320, 13, "res/wy/public/an_kjhs.png")
	...
	-- Create Button_page1
	local Button_page1 = GUI:Button_Create(Panel_1, "Button_page1", -12.00, 410.00, "res/public/1900000641_1.png")
	...
	-- Create Button_page2
	local Button_page2 = GUI:Button_Create(Panel_1, "Button_page2", -12.00, 343.00, "res/public/1900000641_1.png")
	...
	-- Create Button_page3
	local Button_page3 = GUI:Button_Create(Panel_1, "Button_page3", -12.00, 276.00, "res/public/1900000641_1.png")
	...
	-- Create Button_page4
	local Button_page4 = GUI:Button_Create(Panel_1, "Button_page4", -12.00, 209.00, "res/public/1900000641_1.png")
	...
	-- Create Button_page5
	local Button_page5 = GUI:Button_Create(Panel_1, "Button_page5", -12.00, 142.00, "res/public/1900000641_1.png")
	...
	-- Create Image_gold
	local Image_gold = GUI:Image_Create(Panel_1, "Image_gold", 30.00, 102.00, "res/public/1900000511.png")
	...
	local Button_store_hero_bag = GUI:Button_Create(Panel_1, "Button_store_hero_bag", 250.00, 131.00, "res/public/1900000652.png")
	...
	-- Create Image_goldBg
	GUI:Image_Create(Panel_1, "Image_goldBg1", 283, 90.00, "res/wy/public/bag_hb_1.png")
	GUI:Image_Create(Panel_1, "Image_goldBg2", 283, 65.00, "res/wy/public/bag_hb_2.png")
	GUI:Image_Create(Panel_1, "Image_goldBg3", 283, 40.00, "res/wy/public/bag_hb_3.png")

	GUI:Image_Create(Panel_1, "Image_bd_goldBg1", 63.00, 90.00, "res/wy/public/bag_bd_hb_1.png")
	GUI:Image_Create(Panel_1, "Image_bd_goldBg2", 63.00, 65.00, "res/wy/public/bag_bd_hb_2.png")
	GUI:Image_Create(Panel_1, "Image_bd_goldBg3", 63.00, 40.00, "res/wy/public/bag_bd_hb_3.png")

	-- Create Text_goldNum1
	local Text_goldNum1 = GUI:Text_Create(Panel_1, "Text_goldNum1", 283.00 + 125, 90.00 + 3, 16, "#FFFF00", [[0]])
	GUI:setChineseName(Text_goldNum1, "背包_金币数量")
	GUI:setTouchEnabled(Text_goldNum1, false)
	GUI:setAnchorPoint(Text_goldNum1, 0.50, 0)
	GUI:setTag(Text_goldNum1, -1)
	GUI:Text_enableOutline(Text_goldNum1, "#000000", 1)

	-- Create Text_goldNum3
	local Text_goldNum3 = GUI:Text_Create(Panel_1, "Text_goldNum3", 63.00 + 160, 90.00 + 3, 16, "#00FF00", [[0]])
	...
	local Text_goldNum2 = GUI:Text_Create(Panel_1, "Text_goldNum2", 283.00 + 125, 65.00 + 3, 16, "#FFFF00", [[0]])
	...
	local Text_goldNum4 = GUI:Text_Create(Panel_1, "Text_goldNum4", 63.00 + 160, 65.00 + 3, 16, "#00FF00", [[0]])
	...
	local Text_goldNum7 = GUI:Text_Create(Panel_1, "Text_goldNum7", 283.00 + 125, 40.00 + 3, 16, "#FFFF00", [[0]])
	...
	local Text_goldNum8 = GUI:Text_Create(Panel_1, "Text_goldNum8", 63.00 + 160, 40.00 + 3, 16, "#00FF00", [[0]])
