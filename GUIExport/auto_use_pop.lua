...
function ui.init(parent)
	...
	-- Create ItemBg
	local ItemBg = GUI:Image_Create(PPopUI, "ItemBg", 69.00, 116.00, "res/public/1900000651.png")
	...
	-- Create TextName
	local TextName = GUI:Text_Create(PPopUI, "TextName", 69.00, 62.00, 16, "#ffffff", [[]])
	...
	-- Create TextTime
	local TextTime = GUI:Text_Create(PPopUI, "TextTime", 123.00, 25.00, 16, "#ffffff", [[]])
	...
	GUI:Win_SetParam(BtnUse, {grey = 1}, "Button")
	...
	-- Create BtnClose
	local BtnClose = GUI:Button_Create(PPopUI, "BtnClose", 129.00, 135.00, "res/public/1900000510.png")
	...
	GUI:Win_SetParam(BtnClose, {grey = 1}, "Button")
