...
function ui.init(parent)
	...
	GUI:Win_SetParam(Button_invite, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_member, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_team, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_player, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_monster, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_hero, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_empty, {grey = 1}, "Button")
	...
	-- Create Panel_hide
	local Panel_hide = GUI:Layout_Create(Node, "Panel_hide", 241.00, 0.00, 21.00, 188.00, false)
