...
function ui.init(parent)
	...
	-- Create Panel_assist
	local Panel_assist = GUI:Layout_Create(Node, "Panel_assist", -35.00, 0.00, 244.00, 188.00, false)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_content, "Image_1", 99.00, 94.00, "res/private/main/assist/1900012571.png")
	...
	local Panel_mission = GUI:Layout_Create(Panel_content, "Panel_mission", -2.00, 0.00, 202.00, 188.00, false)
	...
	GUI:setVisible(BtnG_content, false)
	...
	GUI:setVisible(Button_team, false)
	...
	GUI:setVisible(BtnG_enemy, false)
	...
	GUI:setVisible(Button_player, false)
	...
	GUI:setVisible(Button_monster, false)
	...
	GUI:setVisible(BtnG_hero, false)
	...
	GUI:setVisible(Button_hero, false)
	...
	-- Create Panel_hide
	local Panel_hide = GUI:Layout_Create(Node, "Panel_hide", 206.00, 0.00, 21.00, 188.00, false)
