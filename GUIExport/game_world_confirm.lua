...
function ui.init(parent)
	...
	-- Create ConfirmBG
	local ConfirmBG = GUI:Image_Create(parent, "ConfirmBG", 568.00, 320.00, "res/wy/public/login_206.png")
	...
	local ConfirmButton = GUI:Button_Create(ConfirmBG, "ConfirmButton", 247.00, 127.00, "res/wy/public/login_205.png")
	GUI:Button_loadTexturePressed(ConfirmButton, "res/wy/public/login_205.png")
	...
	GUI:Win_SetParam(ConfirmButton, {grey = 1}, "Button")
	...
	local RemainingText = GUI:Text_Create(ConfirmBG, "RemainingText", 300.00, 130.00, 18, "#ffffff", [[(3)]])
