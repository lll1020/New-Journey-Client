...
function ui.init(parent)
	...
	GUI:Win_SetParam(btn_takeOut_all, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(btn_delete_read, {grey = 1}, "Button")
...
件]])
	...
	GUI:Win_SetParam(btn_takeOut, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(btn_delete, {grey = 1}, "Button")
	...
	-- Create Text
	local Text = GUI:Text_Create(parent, "Text", 262.00, 128.00, 20, "#9d0000", [[邮件上限100封，需尽快提取，避免奖励丢失]])
