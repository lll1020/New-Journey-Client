...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 174.00, 435.00, 17, "#d8c8ae", [[123]])
	...
	-- Create AttachLayout
	local AttachLayout = GUI:Layout_Create(FrameLayout, "AttachLayout", 72.00, 16.00, 608.00, 391.00, false)
	...
	-- Create page_cell_1
	local page_cell_1 = GUI:Button_Create(FrameLayout, "page_cell_1", 698.00, 325.00, "res/wy/public/guild_1.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 15.00, 44.00, 18, "#807256", [[附
近]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_1, "TouchSize", 4.00, 81.00, 25.00, 75.00, false)
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 15.00, 44.00, 18, "#807256", [[组
队]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_2, "TouchSize", 4.00, 82.00, 25.00, 75.00, false)
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 15.00, 44.00, 18, "#807256", [[好
友]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_3, "TouchSize", 4.00, 81.00, 25.00, 75.00, false)
	...
	-- Create page_cell_4
	local page_cell_4 = GUI:Button_Create(FrameLayout, "page_cell_4", 698.00, 58.00, "res/wy/public/guild_1.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_4, "PageText", 15.00, 44.00, 18, "#807256", [[邮
件]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(page_cell_4, "TouchSize", 3.00, 83.00, 25.00, 75.00, false)
