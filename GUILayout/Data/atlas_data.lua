            ...
            maps = {
                {
                    ...
                    name = "盟重省",
                    monster = {
                        {id = "m_1_1_1", name = "盟重教主", model = 25, reward = {{"金币", 10000}}},
                        {id = "m_1_1_2", name = "赤月魔王", model = 1000, reward = {{"千年玄铁", 1}}},
                        {id = "m_1_1_3", name = "暗影统领", model = 100, reward = {{"辉耀水晶", 1}}},
                        {id = "m_1_1_4", name = "远古巨龙", model = 1234, reward = {{"绑定灵石", 10}}},
                    },
                    equip = {
