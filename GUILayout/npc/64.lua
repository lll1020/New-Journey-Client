...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function open_baby_preview_window(idx, opts)
        ...
        if status == "未孵化" then
            ...
            claimBtn = GUI:Button_Create(node, "claim_btn", 790, 86, "res/custom/four_city/lingshou/xjm/an7.png")
        ...
        if claimBtn and canDeploy then
        ...
        elseif claimBtn and canClaim then
