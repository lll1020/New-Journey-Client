...
npc._config = teshudata["npc_624"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/3/624_bg.png"},
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        elseif npc.data.T_dljq[key] == 1 then
            local desc = GUI:Text_Create(node, "desc",300,220, 20, "#F4D179", "当前击杀："..(npc.data.sg_data[key] or 0).."/"..(npc._config.num or 0))
