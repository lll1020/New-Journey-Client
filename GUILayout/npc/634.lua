...
npc._config = teshudata["npc_634"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/3/634_bg.png"},
    ...
    local function UI_updata(node)
       ...
       local ch_kuang = GUI:Image_Create(node, "ch_kuang", 240 + 320 - 410 + 235, 105, "res/wy/public/70_70_k.png")
        ...
        elseif npc.data.jq_data[key] == 1 then --领取奖励
            local desc = GUI:Text_Create(node, "desc",520,200, 20, "#808080", "当前击杀："..(npc.data.sg_data[key] or 0))
