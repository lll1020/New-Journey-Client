...
npc._config = teshudata["npc_637"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/3/637_bg.png"},
    closeButton = {x = 747, y = 380},
}
local key = "npc_637"
local btn_pos = {600, 110}
local cost_pos = {510, 202 + 40}
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        local ch_kuang = GUI:Image_Create(node, "ch_kuang", 240 + 320 - 410 + 264, 128, "res/wy/public/70_70_k.png")
