...
npc._config = teshudata["npc_663"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/4/663_bg.png"},
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        local text = GUI:Text_Create(node, "text", 507 + 25 - 363, 202 + 10 - 90, 30, "#00FFFF", "当前人物等级 + 1" )
