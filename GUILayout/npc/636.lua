...
local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/3/636_bg.png"},
    closeButton = {x = 747, y = 380},
}
local key = "npc_636"
local btn_pos = {600, 110}
local cost_pos = {507 - 230, 202 + 110}
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        GUI:setPosition(jl, 330 + 44 - 170, 120 + 100)
        ...
        if npc.data.T_dljq[key] < npc._config.max_num then
            local Button= GUI:Button_Create(node, "Button", btn_pos[1], btn_pos[2], showFirstOpenTake and "res/custom/all_story_mission/2/btn_take.png" or "res/custom/all_story_mission/3/btn_636.png")
