...
npc._config = teshudata["npc_604"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/2/604_bg.png"},
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        elseif npc.data.jq_data[key] == 1 then
            local desc = GUI:Text_Create(node, "desc",300,170, 20, "#FFFFFF", "当前击杀：\n[寒霜狐] "..(npc.data.sg_data[key.."_a"] or 0).."\n[冰羽雀] "..(npc.data.sg_data[key.."_b"] or 0))
