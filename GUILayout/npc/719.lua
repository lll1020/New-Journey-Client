...
npc._config = teshudata["npc_719"]

local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/5/719_bg.png"},
...
local MAIN_BTN_SKIN = "res/custom/all_story_mission/5/719/1.png"
local MAIN_BTN_SKIN_TAKE = "res/custom/all_story_mission/5/719/1.png"
local MAIN_BTN_SKIN_DOING = "res/custom/all_story_mission/5/719/2.png"
