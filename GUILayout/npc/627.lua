...
local function renderReward(node, reward)
    ...
    createOutlineText(node, "tip1", 330 + 110, 120 + 30 - 30, "讨\n伐\n奖\n励", "#FFE46C", 14)
    local rewardNode = ItemNumByTable_img_new(reward, nil, GUI:Node_Create(node, "jl", 0, 0))
    GUI:setPosition(rewardNode, 330 + 135, 120 + 40 - 30)
    createOutlineText(node, "tip2", 330 + 110 + 150, 120 + 30 - 30, "关\n键\n物\n品", "#FFE46C", 14)
    local rewardNode2 = ItemNumByTable_img_new({{npc._config.prep_task.name, 1}}, nil, GUI:Node_Create(node, "jl1", 0, 0))
    GUI:setPosition(rewardNode2, 330 + 135 + 150, 120 + 40 - 30)
end
