...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function GUI_createLabel(Label_node,idx)
        ...
        -- 
        local sywCost = {{npc._config.config.ls[npc.titles_sign].syw, 1}, {"元宝", 1880000}, {"辉耀水晶", 88}}
        local cost = checkItemNumByTable_img_kuang_compact(sywCost, nil, Label_node, 62)
        GUI:setPosition(cost, 430 + 160, 110)
