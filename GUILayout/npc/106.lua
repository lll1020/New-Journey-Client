...
-- -- 9.8-1 聚宝盆碎片任务材料检查与展示已停用。
-- -- 9.8-1 原客户端材料判断：return n(d.activated) < 1 and n(d.fragment_have) >= n(d.fragment_need)
-- local function canRebuildTask()
--     local d = data()
--     return n(d.activated) < 1
-- end

-- -- 9.8-1 原客户端材料展示：checkItemNumByTable_img_kuang({{fragmentName, need}}, nil, task_cost_show)
...
--         text(node, "task_need_desc", -92 - 70 - 133, 17 - 40, 26, "#66CCFF", "当前无需收集材料", 0.5, 0.5)
...
--         local taskTip1 = text(node, "task_tip_1", -118, -194 - 50, 22, "#66CCFF", "点击此处前往在线充值，领取第一档奖励", 0.5, 0.5)
