...
npc.iconpx = {
    ...
    {
        {12, "在线充值", 502,11}, {2, "交易行",510,12},{4, "解绑特权",504,13},{4, "狂暴之力",513,14},{4, "世界地图",514,15},{4, "免费赞助",516,15}
    }
}
...
npc.xyl = {
        ...
        {
            {
                ...
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
    ...
    },
    {
        {
            {
                { "盾牌强化",2,yz = {16,20111}, yd = {1,"中州城",158,648,178},jl = {{"1元真实充值",1} } ,desc = "盾牌强化至LV10\\(<提升核心属性/FCOLOR=250>)" },
                { "猎魔前线-救治灵树",1,yz = {2,"npc401",2},yd = {1,"猎魔前线",401,33,27},jl = {{"1元真实充值",1}}},
                { "猎魔前线-三相之力",1,yz = {2,"npc402",2},yd = {1,"血戮荒原",402,323,153},jl = {{"1元真实充值",1}}},
                { "猎魔前线-祭拜苍天",1,yz = {2,"npc403",2},yd = {1,"魔息战场",403,117,26},jl = {{"1元真实充值",1}}},
                { "猎魔前线-除魔问道",1,yz = {2,"npc404",2},yd = {1,"暗影哨所",404,252,67},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "职业觉醒",3, yd = {1,"中州城",176,654,178},jl = {{"1元真实充值",1} } ,desc = "完成职业一觉\\(<激活觉醒技能/FCOLOR=250>)" },
                { "上古丛林-全是好物",1,yz = {1,"npc407",2},yd = {1,"上古丛林",407,69,170},jl = {{"1元真实充值",1}}},
                { "上古丛林-酒鬼老王",1,yz = {1,"npc408",2},yd = {1,"迷踪秘径",408,152,29},jl = {{"1元真实充值",1}}},
                { "上古丛林-吉祥三宝",1,yz = {1,"npc409",2},yd = {1,"藤蔓荒谷",409,118,45},jl = {{"1元真实充值",1}}},
                { "上古丛林-上古剑诀",1,yz = {1,"npc410",2},yd = {1,"古木幽庭",410,167,133},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "专属开光",999,{3,3043}, yd = {1,"中州城",183,652,175},jl = {{"1元真实充值",1} } ,desc = "查看专属开光\\(<核心玩法，大幅提升属性/FCOLOR=250>)" },
                { "灵气矿场-矿场密宝",1,yz = {1,"npc413",2},yd = {1,"灵气矿场",413,277,27},jl = {{"1元真实充值",1}}},
                { "灵气矿场-挖矿达人",1,yz = {1,"npc414",2},yd = {1,"晶尘之路",414,23,259},jl = {{"1元真实充值",1}}},
                { "灵气矿场-协助老朽",1,yz = {1,"npc415",2},yd = {1,"灵岩矿井",415,280,55},jl = {{"1元真实充值",1}}},
                { "灵气矿场-灵气起源",1,yz = {2,"npc416",2},yd = {1,"涌泉之脉",416,23,268},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "中州城势力",999,{3,3044}, yd = {1,"中州城",45,652,175},jl = {{"1元真实充值",1} } ,desc = "查看中州城传送阵\\(<加入中州城任意势力/FCOLOR=250>)" },
                { "不朽领域-不朽秘宝",1,yz = {1,"npc419",2},yd = {1,"不朽领域",419,35,352},jl = {{"1元真实充值",1}}},
                { "不朽领域-老僧的烦恼",1,yz = {1,"npc420",2},yd = {1,"永生之塔",420,66,322},jl = {{"1元真实充值",1}}},
                { "不朽领域-不玩虚的",1,yz = {2,"npc421",2},yd = {1,"不灭神坛",421,16,316},jl = {{"1元真实充值",1}}},
                { "不朽领域-神秘宝箱",1,yz = {1,"npc422",2},yd = {1,"轮回圣殿",422,276,35},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "勋章强化",2,yz = {15,20011}, yd = {4,100,160,0,0},jl = {{"1元真实充值",1} } ,desc = "徽章强化至LV10\\(<提升核心属性/FCOLOR=250>)" },
                { "诡秘深渊-交个朋友",1,yz = {1,"npc425",2},yd = {1,"诡秘深渊",425,45,141},jl = {{"1元真实充值",1}}},
                { "诡秘深渊-智慧之神",1,yz = {2,"npc426",2},yd = {1,"幽影峡谷",426,101,280},jl = {{"1元真实充值",1}}},
                { "诡秘深渊-欢度元宵",1,yz = {2,"npc427",2},yd = {1,"邪魂之渊",427,185,200},jl = {{"1元真实充值",1}}},
                { "诡秘深渊-上古恶魔",1,yz = {2,"npc428",2},yd = {1,"深渊幽宫",428,19,239},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "完成四大陆转生",12,{4},yd = {1,"中州城",124,644,192},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>完成四大陆转生\\(<提升核心属性/FCOLOR=250>)" },
                { "北辰山脉-北辰秘宝",1,yz = {1,"npc431",2},yd = {1,"北辰山脉",431,441,220},jl = {{"1元真实充值",1}}},
                { "北辰山脉-救济老朽",1,yz = {1,"npc432",2},yd = {1,"霜风雪岭",432,35,222},jl = {{"1元真实充值",1}}},
                { "北辰山脉-神秘高人",1,yz = {1,"npc433",2},yd = {1,"极寒冰崖",433,233,38},jl = {{"1元真实充值",1}}},
                { "北辰山脉-我摇人了",1,yz = {2,"npc434",2},yd = {1,"天霄之径",434,218,30},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
        },
    },
    {
        {
            ...
            {
                { "群切强化",4,yd = {1,"天玄界",58,42,38},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>激活群切强化\\(<大幅提高打怪速度/FCOLOR=250>)" },
                { "幽冥邪宗-幽冥至宝",1,yz = {1,"npc437",2},yd = {1,"幽冥邪宗",437,34,39},jl = {{"1元真实充值",1}}},
                { "幽冥邪宗-磨刀向恶魔",1,yz = {2,"npc438",2},yd = {1,"血池溅月",438,172,172},jl = {{"1元真实充值",1}}},
                { "幽冥邪宗-血洗邪宗",1,yz = {2,"npc439",2},yd = {1,"邪影噬魂坛",439,24,91},jl = {{"1元真实充值",1}}},
                { "幽冥邪宗-斩草除根",1,yz = {2,"npc440",2},yd = {1,"千目凝视之谷",440,23,89},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "根基洗炼",999,{3,3045}, yd = {1,"天玄界",57,51,38},jl = {{"1元真实充值",1} } ,desc = "查看根基洗炼\\(<每日可以免费洗炼一次/FCOLOR=250>)" },
                { "边境之城-边境至宝",1,yz = {1,"npc442",2},yd = {1,"边境之城",442,37,67},jl = {{"1元真实充值",1}}},
                { "边境之城-边境试炼",1,yz = {2,"npc443",2},yd = {1,"狼烟起",443,31,33},jl = {{"1元真实充值",1}}},
                { "边境之城-寻宝神潭",1,yz = {2,"npc444",2},yd = {1,"孤军守残垒",444,33,179},jl = {{"1元真实充值",1}}},
                { "边境之城-边境大使",1,yz = {1,"npc445",2},yd = {1,"铁壁营寨烽火天",445,16,141},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "职业升级",5,yd = {1,"天玄界",168,54,38},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>职业强化至LV100\\(<提升职业属性/FCOLOR=250>)" },
                { "无尽深渊-深渊夺宝",1,yz = {1,"npc447",2},yd = {1,"无尽深渊",447,84,111},jl = {{"1元真实充值",1}}},
                { "无尽深渊-无尽神道",1,yz = {2,"npc448",2},yd = {1,"黑渊幽径",448,94,73},jl = {{"1元真实充值",1}}},
                { "无尽深渊-深渊谜题",1,yz = {2,"npc449",2},yd = {1,"深海无声谷",449,85,37},jl = {{"1元真实充值",1}}},
                { "无尽深渊-收集魔气",1,yz = {1,"npc450",2},yd = {1,"血肉风暴裂魂隙",450,93,97},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "仙府遗迹-仙府宝藏",1,yz = {1,"npc452",2},yd = {1,"仙府遗迹",452,121,122},jl = {{"1元真实充值",1}}},
                { "仙府遗迹-光暗双生",1,yz = {2,"npc453",2},yd = {1,"仙池碧玉",453,208,208},jl = {{"1元真实充值",1}}},
                { "仙府遗迹-无边业火",1,yz = {2,"npc454",2},yd = {1,"莲灯未冷时",454,217,227},jl = {{"1元真实充值",1}}},
                { "仙府遗迹-控火导师",1,yz = {2,"npc455",2},yd = {1,"星陨回响天幕影",455,230,198},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "盾牌强化",2,yz = {16,20141}, yd = {1,"中州城",158,648,178},jl = {{"1元真实充值",1} } ,desc = "盾牌强化至LV40\\(<提升核心属性/FCOLOR=250>)" },
                { "副装系统",999,{3,3054}, yd = {1,"天玄界",185,40,38},jl = {{"1元真实充值",1} } ,desc = "核心玩法\\副装和转职的结合" },
                { "天妖山脉-天妖夺宝",1,yz = {1,"npc457",2},yd = {1,"天妖山脉",457,301,330},jl = {{"1元真实充值",1}}},
                { "天妖山脉-天妖试炼",1,yz = {2,"npc458",2},yd = {1,"狂啸绝壁",458,35,35},jl = {{"1元真实充值",1}}},
                { "天妖山脉-五行混沌体",1,yz = {2,"npc459",2},yd = {1,"血兽战吼山巅",459,51,368},jl = {{"1元真实充值",1}}},
                { "天妖山脉-修行之路",1,yz = {1,"npc460",2},yd = {1,"妖骨盘涡毒息林",460,130,283},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "完成五大陆转生",12,{5},yd = {1,"天玄界",143,39,45},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>完成五大陆转生\\(<提升核心属性/FCOLOR=250>)" },
                { "圣墟秘境-圣虚秘宝",1,yz = {1,"npc462",2},yd = {1,"圣墟秘境",462,30,28},jl = {{"1元真实充值",1}}},
                { "圣墟秘境-神之恩赐",1,yz = {2,"npc463",2},yd = {1,"圣者归途",463,30,32},jl = {{"1元真实充值",1}}},
                { "圣墟秘境-圣虚之主",1,yz = {2,"npc464",2},yd = {1,"光焰引路泉影照",464,251,272},jl = {{"1元真实充值",1}}},
                { "圣墟秘境-兵神天狼",1,yz = {1,"npc465",2},yd = {1,"黄金遗冢",465,22,77},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
        }
    },
    {
        {
            {
                { "迷城幻境-迷城秘宝",1,yz = {1,"npc467",2},yd = {1,"迷城幻境",467,62,66},jl = {{"1元真实充值",1}}},
                { "迷城幻境-破妄之瞳",1,yz = {1,"npc468",2},yd = {1,"影火幽街",468,170,160},jl = {{"1元真实充值",1}}},
                { "迷城幻境-迷城雾鬼",1,yz = {2,"npc469",2},yd = {1,"虚实难辨馆中影",469,140,174},jl = {{"1元真实充值",1}}},
                { "迷城幻境-肉就完了",1,yz = {1,"npc470",2},yd = {1,"星屑回廊",470,67,219},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "隐仙居",7,yz = {0,"仙气之体"},yd = {1,"北境仙域",102,44,37},jl = {{"1元真实充值",1} },desc = "在隐仙居中完成仙气转换\\(<将灵气转换为仙气/FCOLOR=250>)" },
                { "战歌要塞-要塞寻宝",1,yz = {1,"npc472",2},yd = {1,"战歌要塞",472,103,29},jl = {{"1元真实充值",1}}},
                { "战歌要塞-战歌试炼",1,yz = {2,"npc473",2},yd = {1,"战鼓不息",473,28,186},jl = {{"1元真实充值",1}}},
                { "战歌要塞-灵星起源",1,yz = {2,"npc474",2},yd = {1,"铁狮门楼风中望",474,14,30},jl = {{"1元真实充值",1}}},
                { "战歌要塞-复仇的怒火",1,yz = {2,"npc475",2},yd = {1,"赤焰兵坊",475,209,228},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "斗笠强化",2,yz = {13,21108}, yd = {4,100,159,0,0},jl = {{"1元真实充值",1} } ,desc = "斗笠强化至LV20\\(<提升核心属性/FCOLOR=250>)" },
                { "荒古战场-战场寻宝",1,yz = {1,"npc477",2},yd = {1,"荒古战场",477,249,22},jl = {{"1元真实充值",1}}},
                { "荒古战场-荒古夺魁",1,yz = {2,"npc478",2},yd = {1,"血腥废墟",478,165,198},jl = {{"1元真实充值",1}}},
                { "荒古战场-战场杀神",1,yz = {2,"npc479",2},yd = {1,"废土遗址",479,165,199},jl = {{"1元真实充值",1}}},
                { "荒古战场-荒古战神令",1,yz = {1,"npc480",2},yd = {1,"英雄遗墟",480,356,341},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "护体罡气",7,yz = {0,"护体罡气"}, yd = {1,"北境仙域",79,47,37},jl = {{"1元真实充值",1} } ,desc = "护体罡气强化至LV20\\(<提升核心属性/FCOLOR=250>)" },
                { "魁族蛮荒-蛮荒寻宝",1,yz = {1,"npc483",2},yd = {1,"魁族蛮荒",483,42,58},jl = {{"1元真实充值",1}}},
                { "魁族蛮荒-平定蛮荒",1,yz = {2,"npc484",2},yd = {1,"蛮骨平原",484,25,91},jl = {{"1元真实充值",1}}},
                { "魁族蛮荒-攻魔道",1,yz = {2,"npc485",2},yd = {1,"血牙山脉",485,38,141},jl = {{"1元真实充值",1}}},
                { "魁族蛮荒-魁族谜题",1,yz = {2,"npc486",2},yd = {1,"荒灵沼泽",486,34,257},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "职业二觉",999,{3,3047}, yd = {1,"北境仙域",177,51,37},jl = {{"1元真实充值",1} } ,desc = "职业二觉\\(<可以习得新的职业技能/FCOLOR=250>)" },
                { "苍穹之域-苍穹寻宝",1,yz = {1,"npc489",2},yd = {1,"苍穹之域",489,51,45},jl = {{"1元真实充值",1}}},
                { "苍穹之域-苍穹神树",1,yz = {2,"npc490",2},yd = {1,"云阙天宫",490,48,357},jl = {{"1元真实充值",1}}},
                { "苍穹之域-美味的菜肴",1,yz = {1,"npc491",2},yd = {1,"星轮天池",491,52,359},jl = {{"1元真实充值",1}}},
                { "苍穹之域-苍穹水晶",1,yz = {2,"npc492",2},yd = {1,"玄霄浮岛",492,26,39},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "仙道赐福",7,yz = {0,"仙道赐福"}, yd = {1,"北境仙域",110,63,49},jl = {{"1元真实充值",1} } ,desc = "进行50次仙道赐福\\(<获得大量材料和稀有奖励/FCOLOR=250>)" },
                { "混沌荒原-荒原寻宝",1,yz = {1,"npc495",2},yd = {1,"混沌荒原",495,132,60},jl = {{"1元真实充值",1}}},
                { "混沌荒原-混沌真龙",1,yz = {1,"npc496",2},yd = {1,"破界荒墟",496,232,254},jl = {{"1元真实充值",1}}},
                { "混沌荒原-复仇的怒火",1,yz = {2,"npc497",2},yd = {1,"湮灵断层",497,269,123},jl = {{"1元真实充值",1}}},
                { "混沌荒原-不死金刚",1,yz = {1,"npc498",2},yd = {1,"裂魂战渊",498,236,252},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
        },
    },
    {
        {
            {
                { "切割之斧",2,yz = {12,20400}, yd = {4,100,41,0,0},jl = {{"1元真实充值",1} } ,desc = "切割之斧强化至LV35\\(<提升核心属性/FCOLOR=250>)" },
                { "赤焰火洲-赤焰宝藏",1,yz = {1,"npc500",2},yd = {1,"赤焰火洲",500,277,281},jl = {{"1元真实充值",1}}},
                { "赤焰火洲-炽焰之力",1,yz = {2,"npc501",2},yd = {1,"炎心古原",501,239,259},jl = {{"1元真实充值",1}}},
                { "赤焰火洲-火焰之花",1,yz = {1,"npc502",2},yd = {1,"焰火炼狱",502,25,22},jl = {{"1元真实充值",1}}},
                { "赤焰火洲-我全都要",1,yz = {2,"npc503",2},yd = {1,"燎原赤林",503,70,71},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "职业觉醒",8,yd = {1,"中央仙域",178,18,17},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>完成职业三觉\\(<激活三觉技能/FCOLOR=250>)" },
                { "海蓝天岛-天岛宝藏",1,yz = {1,"npc505",2},yd = {1,"海蓝天岛",505,87,61},jl = {{"1元真实充值",1}}},
                { "海蓝天岛-阴阳双生",1,yz = {1,"npc506",2},yd = {1,"澜光浅湾",506,74,85},jl = {{"1元真实充值",1}}},
                { "海蓝天岛-踏碎山河",1,yz = {2,"npc507",2},yd = {1,"云汐悬崖",507,91,189},jl = {{"1元真实充值",1}}},
                { "海蓝天岛-突出重围",1,yz = {2,"npc508",2},yd = {1,"天镜湖心",508,93,300},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "群切强化",9,yd = {4,100,58,0,0},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>群切强化至LV20\\(<大幅提高打怪速度/FCOLOR=250>)" },
                { "禁忌之森-禁忌宝藏",1,yz = {1,"npc511",2},yd = {1,"禁忌之森",511,277,125},jl = {{"1元真实充值",1}}},
                { "禁忌之森-百转轮回",1,yz = {2,"npc512",2},yd = {1,"幽藤迷径",512,212,195},jl = {{"1元真实充值",1}}},
                --{ "禁忌之森-藏宝图",1,yz = {2,"npc513",2},yd = {1,"幽冥沼泽",513,39,92},jl = {{"1元真实充值",1}}},
                { "禁忌之森-一剑开天",1,yz = {1,"npc514",2},yd = {1,"暗影秘境",514,209,216},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "盾牌强化",2,yz = {16,20121}, yd = {4,100,158,0,0},jl = {{"1元真实充值",1} } ,desc = "盾牌强化至LV20\\(<提升核心属性/FCOLOR=250>)" },
                { "鬼嚎深渊-深渊寻宝",1,yz = {1,"npc517",2},yd = {1,"鬼嚎深渊",517,346,164},jl = {{"1元真实充值",1}}},
                { "鬼嚎深渊-打碎枷锁",1,yz = {2,"npc518",2},yd = {1,"哀魂断口",518,302,37},jl = {{"1元真实充值",1}}},
                { "鬼嚎深渊-荣誉之战",1,yz = {2,"npc519",2},yd = {1,"魍魉幽道",519,373,72},jl = {{"1元真实充值",1}}},
                { "鬼嚎深渊-无极老人",1,yz = {2,"npc520",2},yd = {1,"死域祭坛",520,100,276},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "仙气萃取",999,{3,3049}, yd = {1,"中央仙域",170,21,17},jl = {{"1元真实充值",1} } ,desc = "查看仙气萃取\\(<可以兑换仙气/FCOLOR=250>)" },

                { "无相领域-无相宝藏",1,yz = {1,"npc523",2},yd = {1,"无相领域",523,256,35},jl = {{"1元真实充值",1}}},
                { "无相领域-祭拜苍天",1,yz = {2,"npc524",2},yd = {1,"虚轮镜界",524,273,245},jl = {{"1元真实充值",1}}},
                { "无相领域-黄鹤归去",1,yz = {2,"npc525",2},yd = {1,"虚幻迷宫",525,264,251},jl = {{"1元真实充值",1}}},
                { "无相领域-一诺千金",1,yz = {2,"npc526",2},yd = {1,"意识荒原",526,279,20},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "完成七大陆转生",12,{7},yd = {1,"中央仙域",162,19,22},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>完成七大陆转生\\(<提升核心属性/FCOLOR=250>)" },

                { "诡异裂缝-神魔惧我",1,yz = {1,"npc529",30},yd = {1,"诡异裂缝",529,122,58},jl = {{"1元真实充值",1}}},
                { "诡异裂缝-夺命诡气",1,yz = {1,"npc527",2},yd = {1,"灵觉浮域",527,259,35},jl = {{"1元真实充值",1}}},
                { "诡异裂缝-诡异之主",1,yz = {2,"npc528",2},yd = {1,"无名之殿",528,206,196},jl = {{"1元真实充值",1}}},
                { "诡异裂缝-猩红之主",1,yz = {2,"npc522",2},yd = {1,"血腥深渊",522,79,177},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
        },
    },
    {
        {
            {
                { "魂卡激活",999,{3,3051}, yd = {1,"诡异位面",153,59,57},jl = {{"1元真实充值",1} } ,desc = "查看魂卡激活\\(<boss魂卡激活/FCOLOR=250>)" },

                { "夜哭寒泉-猩红之月",1,yz = {1,"npc521",2},yd = {1,"夜哭寒泉",521,203,201},jl = {{"1元真实充值",1}}},
                { "夜哭寒泉-女娲的试炼",1,yz = {2,"npc515",2},yd = {1,"死亡古洞",515,87,323},jl = {{"1元真实充值",1}}},
                { "夜哭寒泉-禁忌之主",1,yz = {2,"npc516",2},yd = {1,"月光禁地",516,37,39},jl = {{"1元真实充值",1}}},
                { "夜哭寒泉-海蓝之主",1,yz = {2,"npc510",2},yd = {1,"飓涛涌境",510,345,240},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "职业升华",10,yd = {1,"诡异位面",173,69,63},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>职业升华\\(<职业的最强形态/FCOLOR=250>)" },

                { "蓝珊瑚林-蚩尤的试炼",1,yz = {2,"npc509",2 },yd = {1,"蓝珊瑚林",509,80,134},jl = {{"1元真实充值",1}}},
                { "蓝珊瑚林-他好像一条狗",1,yz = {2,"npc504",2 },yd = {1,"赤光熔坛",504,72,88},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "苍雷裂境-苍穹猎魔使",1,yz = {2,"npc493",2 },yd = {1,"苍雷裂境",493,23,27},jl = {{"1元真实充值",1}}},
                { "苍雷裂境-我有一剑",1,yz = {2,"npc494",2 },yd = {1,"寂寥虚穹",494,40,254},jl = {{"1元真实充值",1}}},
                { "苍雷裂境-世人皆笑我",1,yz = {2,"npc499",2 },yd = {1,"渊炎绝地",499,465,236},jl = {{"1元真实充值",1}}},
                { "苍雷裂境-荒古之谜",1,yz = {1,"npc488",2 },yd = {1,"蛮神遗坛",488,45,35},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "归去来兮",1,yz = {2,"npc481",2 },yd = {1,"古代战堡",481,373,363},jl = {{"1元真实充值",1}}},
                { "荒古密钥",1,yz = {2,"npc482",2 },yd = {1,"雷霆断崖",482,26,220},jl = {{"1元真实充值",1}}},
                { "战意凭风起",1,yz = {2,"npc476",2 },yd = {1,"血焰石阵染疆场",476,44,28},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}

            },
            {
                { "肃清迷城",1,yz = {2,"npc471",2 },yd = {1,"幻纹石径迷途归",471,270,33},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}

            },
            {
                { "完成八大陆转生",12,{8},yd = {1,"诡异位面",163,59,63},jl = {{"1元真实充值",1} },desc = "<核心/FCOLOR=249>完成八大陆转生\\(<提升核心属性/FCOLOR=250>)" },

                { "圣虚斩魔",1,yz = {2,"npc466",2 },yd = {1,"天启之门",466,42,85},jl = {{"1元真实充值",1}}},
                { "掀翻它们",1,yz = {2,"npc461",2 },yd = {1,"万蛇洞窟",461,22,267},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
        },
    },
    {
        {
            {
                { "清理门户",1,yz = {2,"npc456" ,2},yd = {1,"风雷禁阁",456,207,93},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
            },
            {
                { "深渊之主",1,yz = {2,"npc451" ,2},yd = {1,"迷影石廊",451,25,72},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}

            },
            {
                { "我要这天",1,yz = {2,"npc446" ,2},yd = {1,"风沙埋骨镇",446,15,98},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}


            },
            {
                { "嗜血杀戮",1,yz = {2,"npc441" ,2},yd = {1,"幽火燃骨坛",441,59,289},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}


            },
            {
                { "妖魔作乱",1,yz = {2,"npc435" ,2},yd = {1,"白峰古道",435,359,44},jl = {{"1元真实充值",1}}},
                { "初识虚渊界",1,yz = {1,"npc436" ,2},yd = {1,"凌云冰谷",436,185,208},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}

            },
            {

                { "杀戮舞曲",1,yz = {2,"npc429" ,2},yd = {1,"诡音回廊",429,44,44},jl = {{"1元真实充值",1}}},
                { "证明自我",1,yz = {1,"npc430" ,2},yd = {1,"迷魂秘径",430,23,215},jl = {{"1元真实充值",1}}},
                jl = {{"绑定元宝",1000000},{"绑定灵符",100000},{"龙纹铜钱",4},{"1元真实充值",5}}
	...
	elseif p2 == 0 then
		...
		function main_ru()
            function new_ziyemian(id)
                ...
                local _wc_num = 0
                local ScrollView_content = GUI:ScrollView_Create(npc.node, "ScrollView_content", 320,143, 650.00, 169, 2)
                GUI:ScrollView_setInnerContainerSize(ScrollView_content, #npc.xyl[npc.jm][npc.l][npc.zj]*318, 169)

                local Layout1 = GUI:Layout_Create(ScrollView_content, "Layout1", 0,0, #npc.xyl[npc.jm][npc.l][npc.zj]*318, 169, false)
                for v,k in pairs(npc.xyl[npc.jm][npc.l][npc.zj] or {}) do
                    ...
                    if k.jl then
                        ...
                        local jl_node =  ItemNumByTable_img(k.jl, nil,num)
                    ...
                    if (npc.data.ywl["jl_"..npc.jm.."_"..npc.l.."_"..npc.zj] and npc.data.ywl["jl_"..npc.jm.."_"..npc.l.."_"..npc.zj] == 1) or
                        ...
                        if k[2] == 999 then
                            if k[3][1] == 3 or k[3][1] == 4 then
                                if npc.data.ywl["rw_"..k[3][2]] and npc.data.ywl["rw_"..k[3][2]] == 1 then
                                    local btn = GUI:Button_Create(bj, "btn_", 220, 30, 'res/custom/ywl/anniu_23_zj_cs_lq.png')
                                    GUI:setAnchorPoint(btn, 0.5, 0.5)
                                    GUI:addOnClickEvent(btn, function()
                                        SL:SendLuaNetMsg(101, 11, 3, 0, '{"i":' .. npc.jm .. ',"j":' .. npc.l .. ',"k":' .. npc.zj .. ',"z":' .. v..'}')
                                    end)
                                else
                                    local btn = GUI:Button_Create(bj, "btn_", 220, 30, 'res/custom/ywl/anniu_23_zj_cs_an.png')
                                    GUI:setAnchorPoint(btn, 0.5, 0.5)
                                    GUI:addOnClickEvent(btn, function()
                        ...
                        elseif k[2] == 1 then
                            ...
                            local img  = canClaim and 'res/custom/ywl/anniu_23_zj_cs_lq.png' or 'res/custom/ywl/anniu_23_zj_cs_an.png'
                ...
                GUI:setPosition(ItemNumByTable_img(npc.xyl[npc.jm][npc.l][npc.zj].jl, nil,npc.node)
                , 450, 80)
        ...
        npc.l = (npc.l and npc.l < 5) and npc.l or 1
        ...
        local function UI_l_updata() --界面渲染
            ...
            for i = 2, 8, 1 do
                ...
                if i == npc.jm then
                    GUI:setLocalZOrder(GUI:Image_Create(npc.ywl_an[npc.jm], "kuang", 0, 0, 'res/custom/ywl/anniu_23_l_kuang.png')
                    , -1)
                    for v,k in pairs(npc.xyl[npc.jm][npc.l]) do
                        local Button= GUI:Button_Create(npc.ywl_list, "Button"..v, 0, 0, "res/public/1900000660.png")
                        GUI:Button_setTitleText(Button, "第"..v.."章")
            ...
            --GUI:ListView_jumpToItem(npc.ywl_list, 10)
        end
        UI_l_updata()
        new_ziyemian(0)
