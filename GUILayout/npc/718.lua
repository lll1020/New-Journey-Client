...
npc._config = teshudata["npc_718"]

local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/5/718_bg.png"},
    closeButton = {x = 747, y = 380},
}
local key = "npc_718"
local btn_pos = {620, 80}
local reward_pos = {180 + 240, 80 + 100}
local cost_pos = {620, 80 + 100}
local MAIN_BTN_SKIN = "res/custom/all_story_mission/5/718/1.png"
local MAIN_BTN_SKIN_TAKE = "res/custom/all_story_mission/5/718/1.png"
local MAIN_BTN_SKIN_DOING = "res/custom/all_story_mission/5/718/2.png"
