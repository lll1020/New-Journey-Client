...
npc._config = teshudata["npc_654"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/4/654_bg.png"},
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        if npc.data.T_dljq[key] == 1 or npc.data.T_dljq[key] == 0 then
            local Button= GUI:Button_Create(node, "Button", btn_pos[1], btn_pos[2], "res/custom/all_story_mission/4/654_btn.png")
