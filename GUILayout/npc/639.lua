...
npc._config = teshudata["npc_639"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/3/639_bg.png"},
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        local ch_kuang = GUI:Image_Create(node, "ch_kuang", 240 + 320 - 368, 160, "res/wy/public/70_70_k.png")
