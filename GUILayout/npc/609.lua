...
npc._config = teshudata["npc_609"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/2/609_bg.png"},
    closeButton = {x = 747, y = 380},
}
local key = "npc_609"
local btn_pos = {462, 70}
local cost_pos = {507 - 240, 202 + 60}
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        GUI:setPosition(jl, 390 - 235, 115 + 50)
        ...
        if npc.data.jq_data[key] == 1 or npc.data.jq_data[key] == 0 then
            ...
            NPC_UI_HELPER.tryStartMainlineUpgradeGuide(npc, Button, node, npcid, "story_609_submit", {
                taskMap = {[npcid] = 33},
                keyPrefix = "mainline_story_609",
                dir = 5,
