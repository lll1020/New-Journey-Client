...
npc._config = teshudata["npc_687"]

local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/5/687_bg.png"},
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function createStateButton(node)
        local Button = GUI:Button_Create(node, "Button", btn_pos[1], btn_pos[2], "res/custom/all_story_mission/5/687_btn.png")
