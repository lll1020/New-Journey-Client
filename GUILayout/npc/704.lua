...
npc._config = teshudata["npc_704"]

local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/5/704_bg.png"},
    closeButton = {x = 747, y = 380},
}
local key = "npc_704"
local btn_pos = {620, 80}
local reward_pos = {420, 120 + 30}
local cost_pos = {500, 220 + 30}
local MAIN_BTN_SKIN = "res/custom/all_story_mission/5/704/1.png"
