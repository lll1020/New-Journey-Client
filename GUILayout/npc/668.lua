...
npc._config = teshudata["npc_668"]



local WINDOW_OPTS = {
    background = {skin = "res/custom/all_story_mission/4/668_bg.png"},
    closeButton = {x = 747, y = 380},
}
local key = "npc_668"
local btn_pos = {700, 110}
local cost_pos = {507 + 25, 202 + 25}
...
function npc.main(npcid, p2, p3, msgData)
    ...
    local function UI_updata(node)
        ...
        local ch_kuang = GUI:Image_Create(node, "ch_kuang", 240 + 320 - 410 + 235 - 191 + 230, 100, "res/wy/public/70_70_k.png")
        ...
        if npc.data.T_dljq[key] == 1 or npc.data.T_dljq[key] == 0 then
            ...
            local Button= GUI:Button_Create(node, "Button", btn_pos[1], btn_pos[2], "res/custom/all_story_mission/4/671_btn.png")
