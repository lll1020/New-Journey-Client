...
local PREP_BUTTON_SKIN = "res/custom/all_story_mission/3/625_btn.png"
...
local function safeKill(data, key)
    local tbl = (data and data.sg_data) or {}
    return tonumber(tbl[key] or 0) or 0
end
...
local function renderReward(node, reward)
    ...
    createOutlineText(node, "tip1", 330 + 110, 120 + 30, "讨\n伐\n奖\n励", "#FFE46C", 14)
