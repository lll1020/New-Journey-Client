...
local function updateUI(npcId, node)
    ...
    if bagBowCount <= 0 then
        ...
        local bowFrame = GUI:Image_Create(node, "equipped_bow_frame", bow_slot_pos[1] + 100, bow_slot_pos[2] - 110, "res/wy/public/70_70_k.png")
