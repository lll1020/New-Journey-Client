...
function SettingAuto.main()
    ...
    --新加内挂
    local Panel_Click = GUI:Layout_Create(SettingAuto._ui.ScrollView_1, "Panel_Click_9999", 370, 330, 235, 40, false)
    GUI:setTouchEnabled(Panel_Click, true)
    local Text_desc = GUI:Text_Create(Panel_Click, "Text_desc", 5, 20, 16, "#ffffff", "被人物攻击随机(CD30秒)")
    GUI:setAnchorPoint(Text_desc, 0, 0.5)
    local CheckBox_able = GUI:Layout_Create(Panel_Click, "CheckBox_able", 200, 19, 44, 18, false)
    GUI:setAnchorPoint(CheckBox_able, 0, 0.5)
    local CheckBox = GUI:CheckBox_Create(CheckBox_able, "an", 0, 0, "res/wy/public/xz_1.png", "res/wy/public/xz_0.png")
    GUI:CheckBox_setSelected(CheckBox, cogin.sjtb.ngkg and cogin.sjtb.ngkg == 1)
    GUI:CheckBox_addOnEvent(CheckBox, function(self)
        SL:SendLuaNetMsg(101, 5, GUI:CheckBox_isSelected(self) and 1 or 0, 0, "")
    end)
end
