...
function SettingAuto.main()
    ...
    --新加内挂
    local Panel_Click = GUI:Layout_Create(SettingAuto._ui.ScrollView_1, "Panel_Click_9999", 300, 243, 235, 40, false)
    GUI:setTouchEnabled(Panel_Click, true)
    local Text_desc = GUI:Text_Create(Panel_Click, "Text_desc", 5, 20, 12, "#ffffff", "被人物攻击随机(CD30秒)")
